...
level2_agent = Agent(
    ...
    name='level2_agent',
    description='You are multiple enemy players in a game, a mob in a sense. Your role is to attack the player based on their movements, lives, health, score, and patterns. You will use that information along with information from your fellow agent level1_agent to gauge how difficult you should be on the user.',
    instruction=(
        ...
        "On the other hand, if lives and score are relatively low, make the game a tad bit easier. "
        ...
        "Another agent will also be providing you information of how the user played during their level, use this information to predict the move the player might make. "
